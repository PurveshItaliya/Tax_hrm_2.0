...
class ColorConst {
  ...
  static Color get goldLight    => const Color(0xFFFFF8E1);
  static Color get goldBorder   => const Color(0xFFFFE082);
  static Color get goldText     => const Color(0xFF6D4C00);
  static Color get goldShadow   => const Color(0x33FFB300);
  static Color get silver       => const Color(0xFF78909C);
  static Color get silverLight  => const Color(0xFFECEFF1);
  static Color get silverBorder => const Color(0xFFB0BEC5);
  static Color get silverText   => const Color(0xFF263238);
  static Color get silverShadow => const Color(0x3378909C);
  static Color get bronze       => const Color(0xFFBF6A00);
  static Color get bronzeLight  => const Color(0xFFFFF3E0);
  static Color get bronzeBorder => const Color(0xFFFFCC80);
  static Color get bronzeText   => const Color(0xFF4E2600);
  static Color get bronzeShadow => const Color(0x33BF6A00);
  static Color get othersHeader      => const Color(0xFFF3F4F6);
  static Color get othersHeaderText  => const Color(0xFF374151);
  static Color get othersBadge       => const Color(0xFF6B7280);
  static Color get greenProgress     => const Color(0xFF10B981);
  static Color get othersAvatar      => const Color(0xFFEEF2FF);
  static Color get othersAvatarText  => const Color(0xFF4F46E5);
  static Color get othersRankBg      => const Color(0xFFF1F5F9);
  static Color get othersRankText    => const Color(0xFF64748B);
