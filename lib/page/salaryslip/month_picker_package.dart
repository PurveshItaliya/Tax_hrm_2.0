...
class SimpleMonthYearPicker {
  ...
  static Future<DateTime> showMonthYearPickerDialog({
    ...
    /// to get current year
    int selectedYear = selectedYears ?? DateTime.now().year;

    /// to get index corresponding to current month (1- Jan, 2- Feb,..)
    var selectedMonth = setCurentMonts ?? DateTime.now().month;
                        ...
                        child: SizedBox(
                          ...
                          child: GridView.builder(
                            ...
                            itemBuilder: (_, index) {
                              ...
                              final bool isFutureMonth = selectedYear == currentYear && month > currentMonth;
                              ...
                              return InkWell(
                                ...
                                child: MonthContainer(
                                  textStyle: isFutureMonth ? TextStyle(color: ColorConst.grey) : monthTextStyle,
