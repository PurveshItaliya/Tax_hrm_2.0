  ...
  void initState() {
    ...
    releaseNotes = [
      ...
      ReleaseNoteItem(
        ...
        version: Platform.isAndroid ? version102 : 'v1.0.1',
        versionName: Platform.isAndroid ? versionName102 : 'Bug Fixes & Improvements',
        date: Platform.isAndroid ? 'July 01, 2026' : 'July 02, 2026',
        category: 'Both',
        icon: Icons.speed,
        bgColor: const Color(0xFF2196F3),
        features: [
