...
//
//     final attendanceLogDelete = attendanceLogDeleteFromJson(jsonString);

// ignore_for_file: prefer_collection_literals

import 'dart:convert';

AttendanceLogDelete attendanceLogDeleteFromJson(String str) => AttendanceLogDelete.fromJson(json.decode(str));

String attendanceLogDeleteToJson(AttendanceLogDelete data) => json.encode(data.toJson());
class AttendanceLogDelete {
  dynamic flag;
  bool? success;
  ...
  AttendanceLogDelete.fromJson(Map<String, dynamic> json) {
    flag = json['Flag'];
