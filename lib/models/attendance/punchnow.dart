...
//
//     final punchNow = punchNowFromJson(jsonString);

// ignore_for_file: prefer_collection_literals

import 'dart:convert';

PunchNow punchNowFromJson(String str) => PunchNow.fromJson(json.decode(str));

String punchNowToJson(PunchNow data) => json.encode(data.toJson());
class PunchNow {
  String? flag;
  bool? success;
  ...
  PunchNow.fromJson(Map<String, dynamic> json) {
    flag = json['Flag'];
