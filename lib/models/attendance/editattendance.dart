...
//
//     final attendanceEdits = attendanceEditsFromJson(jsonString);

// ignore_for_file: prefer_collection_literals

import 'dart:convert';

AttendanceEdits attendanceEditsFromJson(String str) => AttendanceEdits.fromJson(json.decode(str));

String attendanceEditsToJson(AttendanceEdits data) => json.encode(data.toJson());
class AttendanceEdits {
  String? flag;
  bool? success;
  ...
  AttendanceEdits.fromJson(Map<String, dynamic> json) {
    flag = json['Flag'];
