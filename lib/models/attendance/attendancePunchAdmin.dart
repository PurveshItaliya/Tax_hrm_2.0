...
//
//     final adminAttendancePunch = adminAttendancePunchFromJson(jsonString);

// ignore_for_file: prefer_collection_literals

import 'dart:convert';

AdminAttendancePunch adminAttendancePunchFromJson(String str) => AdminAttendancePunch.fromJson(json.decode(str));

String adminAttendancePunchToJson(AdminAttendancePunch data) => json.encode(data.toJson());
class AdminAttendancePunch {
  dynamic flag;
  bool? success;
  ...
  AdminAttendancePunch.fromJson(Map<String, dynamic> json) {
    flag = json['Flag'];
