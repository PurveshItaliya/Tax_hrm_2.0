...
//
//     final additionDeducationEmploye = additionDeducationEmployeFromJson(jsonString);

// ignore_for_file: prefer_collection_literals

import 'dart:convert';

AdditionDeducationEmploye additionDeducationEmployeFromJson(String str) =>
    AdditionDeducationEmploye.fromJson(json.decode(str));

String additionDeducationEmployeToJson(AdditionDeducationEmploye data) =>
    json.encode(data.toJson());

class AdditionDeducationEmploye {
  dynamic flag;
  bool? success;
  dynamic attendence;
  ...
  AdditionDeducationEmploye.fromJson(Map<String, dynamic> json) {
    flag = json['Flag'] ?? "";
